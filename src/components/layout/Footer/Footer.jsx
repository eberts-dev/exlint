					...
					<div className={styles.info}>
						...
						<div className={styles.pad}>
							...
							<div className={styles.social}>
								<svg className={styles.git}><use href="#git"></use></svg>
								<svg className={styles.discord}><use href="#discord"></use></svg>
							</div>

							<Btn>Get Started - It’s Free!</Btn>
							...
							<div className={styles.list}>
								...
								{isAuthenticated ? (
										<div className={styles.userSection}>
											...
											<button className={stylesBtn.login} 
