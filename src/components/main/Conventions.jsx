...
const Conventions = forwardRef((props, ref) => {
	const titles = ['Say goodbye to messy \nmulti-repo coding conventions.']
	...
	const codeLines = [
		...
		},
		{
			number: 2,
			parts: [
				{ cls: 'purple', txt: 'background-color' },
				{ cls: 'white', text: ': black;' },
			],
		},
	...
	return (
		<div className={styles.blur} ref={ref}>
